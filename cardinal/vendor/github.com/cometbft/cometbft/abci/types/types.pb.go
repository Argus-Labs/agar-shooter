...
type Request_GetAppHash struct {
	GetAppHash *RequestGetAppHash `protobuf:"bytes,21,opt,name=get_app_hash,json=getAppHash,proto3,oneof" json:"get_app_hash,omitempty"`
}
type Request_GenerateFraudProof struct {
	GenerateFraudProof *RequestGenerateFraudProof `protobuf:"bytes,22,opt,name=generate_fraud_proof,json=generateFraudProof,proto3,oneof" json:"generate_fraud_proof,omitempty"`
}
type Request_VerifyFraudProof struct {
	VerifyFraudProof *RequestVerifyFraudProof `protobuf:"bytes,23,opt,name=verify_fraud_proof,json=verifyFraudProof,proto3,oneof" json:"verify_fraud_proof,omitempty"`
}
...
type Response_GetAppHash struct {
	GetAppHash *ResponseGetAppHash `protobuf:"bytes,22,opt,name=get_app_hash,json=getAppHash,proto3,oneof" json:"get_app_hash,omitempty"`
}
type Response_GenerateFraudProof struct {
	GenerateFraudProof *ResponseGenerateFraudProof `protobuf:"bytes,23,opt,name=generate_fraud_proof,json=generateFraudProof,proto3,oneof" json:"generate_fraud_proof,omitempty"`
}
type Response_VerifyFraudProof struct {
	VerifyFraudProof *ResponseVerifyFraudProof `protobuf:"bytes,24,opt,name=verify_fraud_proof,json=verifyFraudProof,proto3,oneof" json:"verify_fraud_proof,omitempty"`
}
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
func (c *aBCIClient) DeliverTx(ctx context.Context, in *RequestDeliverTx, opts ...grpc.CallOption) (*ResponseDeliverTx, error) {
	out := new(ResponseDeliverTx)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/DeliverTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIClient) BeginBlock(ctx context.Context, in *RequestBeginBlock, opts ...grpc.CallOption) (*ResponseBeginBlock, error) {
	out := new(ResponseBeginBlock)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/BeginBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIClient) EndBlock(ctx context.Context, in *RequestEndBlock, opts ...grpc.CallOption) (*ResponseEndBlock, error) {
	out := new(ResponseEndBlock)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/EndBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIClient) GetAppHash(ctx context.Context, in *RequestGetAppHash, opts ...grpc.CallOption) (*ResponseGetAppHash, error) {
	out := new(ResponseGetAppHash)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/GetAppHash", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIClient) GenerateFraudProof(ctx context.Context, in *RequestGenerateFraudProof, opts ...grpc.CallOption) (*ResponseGenerateFraudProof, error) {
	out := new(ResponseGenerateFraudProof)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/GenerateFraudProof", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIClient) VerifyFraudProof(ctx context.Context, in *RequestVerifyFraudProof, opts ...grpc.CallOption) (*ResponseVerifyFraudProof, error) {
	out := new(ResponseVerifyFraudProof)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/VerifyFraudProof", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedABCIServer) DeliverTx(ctx context.Context, req *RequestDeliverTx) (*ResponseDeliverTx, error) {
...
func (*UnimplementedABCIServer) BeginBlock(ctx context.Context, req *RequestBeginBlock) (*ResponseBeginBlock, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BeginBlock not implemented")
}
func (*UnimplementedABCIServer) EndBlock(ctx context.Context, req *RequestEndBlock) (*ResponseEndBlock, error) {
...
func (*UnimplementedABCIServer) GetAppHash(ctx context.Context, req *RequestGetAppHash) (*ResponseGetAppHash, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAppHash not implemented")
}
func (*UnimplementedABCIServer) GenerateFraudProof(ctx context.Context, req *RequestGenerateFraudProof) (*ResponseGenerateFraudProof, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateFraudProof not implemented")
}
func (*UnimplementedABCIServer) VerifyFraudProof(ctx context.Context, req *RequestVerifyFraudProof) (*ResponseVerifyFraudProof, error) {
...
func _ABCI_DeliverTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/DeliverTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).DeliverTx(ctx, req.(*RequestDeliverTx))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ABCI_BeginBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestBeginBlock)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).BeginBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/BeginBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).BeginBlock(ctx, req.(*RequestBeginBlock))
	}
	return interceptor(ctx, in, info, handler)
}

func _ABCI_EndBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestEndBlock)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).EndBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/EndBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).EndBlock(ctx, req.(*RequestEndBlock))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ABCI_GetAppHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestGetAppHash)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).GetAppHash(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/GetAppHash",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).GetAppHash(ctx, req.(*RequestGetAppHash))
	}
	return interceptor(ctx, in, info, handler)
}

func _ABCI_GenerateFraudProof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestGenerateFraudProof)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).GenerateFraudProof(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/GenerateFraudProof",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).GenerateFraudProof(ctx, req.(*RequestGenerateFraudProof))
	}
	return interceptor(ctx, in, info, handler)
}

func _ABCI_VerifyFraudProof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestVerifyFraudProof)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).VerifyFraudProof(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/VerifyFraudProof",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).VerifyFraudProof(ctx, req.(*RequestVerifyFraudProof))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCI_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ABCI_BeginBlock_Handler,
		},
		{
			MethodName: "EndBlock",
			Handler:    _ABCI_EndBlock_Handler,
		},
		{
			MethodName: "Commit",
		...
		},
		{
			...
			Handler:    _ABCI_GetAppHash_Handler,
		},
		{
			MethodName: "GenerateFraudProof",
			Handler:    _ABCI_GenerateFraudProof_Handler,
		},
		{
			MethodName: "VerifyFraudProof",
			Handler:    _ABCI_VerifyFraudProof_Handler,
		},
	},
...
func (m *RequestFinalizeBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n33, err33 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.Time, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.Time):])
	if err33 != nil {
		return 0, err33
	}
	i -= n33
...
func (m *Misbehavior) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n71, err71 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.Time, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.Time):])
	if err71 != nil {
		return 0, err71
	}
	i -= n71
