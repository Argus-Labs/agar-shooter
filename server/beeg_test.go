...
func TestPewp(t *testing.T) {
	...
	PushPlayer(PlayerComponent{"a", 100, 0, weapon1, Pair[float64,float64]{250,250}, Pair[float64,float64]{0,0}, Pair[float64,float64]{0,0}, true, -1, 0})
	...
	PushPlayer(PlayerComponent{"b", 100, 0, weapon2, Pair[float64,float64]{750,750}, Pair[float64,float64]{0,0}, Pair[float64,float64]{0,0}, true, -1, 0})
	...
	PushPlayer(PlayerComponent{"c", 100, 0, weapon3, Pair[float64,float64]{500,500}, Pair[float64,float64]{0,0}, Pair[float64,float64]{0,0}, true, -1, 0})
	...
	for i := 0; i < ATTACKPLAYERS; i++ {
		...
		PushPlayer(PlayerComponent{strconv.Itoa(i), livePlayers[strconv.Itoa(i)].Third, 0, weaponi, Pair[float64, float64]{livePlayers[strconv.Itoa(i)].First, livePlayers[strconv.Itoa(i)].Second}, Pair[float64,float64]{0,0}, Pair[float64,float64]{0,0}, true, -1, 0})
	}
	...
	PushPlayer(PlayerComponent{"a", 100, 0, weapon1, Pair[float64,float64]{0,0}, Pair[float64,float64]{0,0}, Pair[float64,float64]{0,0}, true, -1, 0})

	weapon2, _ = World.Create(WeaponComp)
	WeaponComp.Set(World, weapon2, WeaponComponent{Pair[float64, float64]{-1,-1}, Melee, Weapons[Melee].MaxAmmo, 0})
	PushPlayer(PlayerComponent{"b", 100, 0, weapon2, Pair[float64,float64]{1,1}, Pair[float64,float64]{0,0}, Pair[float64,float64]{0,0}, true, -1, 0})
	TickTock()
